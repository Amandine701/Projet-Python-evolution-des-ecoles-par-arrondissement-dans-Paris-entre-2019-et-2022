...
# ---------------------------------- Données recensement logement ------------------------------------------

# Racine https://www.insee.fr/fr/information/2008354

## -------------- Année 2021 pour les logements en zone A (IDF) -----------------------

# https://www.insee.fr/fr/statistiques/8268903?sommaire=8205966#consulter
...
## -------------- Année 2020 pour les logements en zone A (IDF) -----------------

# https://www.insee.fr/fr/statistiques/7705908?sommaire=7637890
...
## -------------------- Année 2019 pour les logements en zone A (IDF) ---------------------------

# https://www.insee.fr/fr/statistiques/6544344?sommaire=6456104
...
# --------------------------------- Données recensement classes d'âge ---------------------------------

## --------- Fichier détaillant la population par classe d'âge dans les arrondissements parisiens en 2019 -----------
...
## ----------- Fichier détaillant la population par classe d'âge dans les arrondissements parisiens en 2021 ----------
